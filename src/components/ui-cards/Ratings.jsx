...
const Ratings = () => {
  return (
    ...
    <div className="bg-[#1f1f1f] w-[350px] md:w-[600px] h-[535px] md:h-[230px] p-[15px] md:mr-[20px] rounded-3xl mb-[15px] md:mb-0">
      <div className="flex flex-col md:flex-row  justify-evenly items-center">
        ...
        <div className="text-center text-[#7A7A7A] px-[100px] py-[20px] md:px-[40px] md:py-[40px] mb-3 md:mb-0   bg-[#212221] shadow-2xl rounded-2xl text-[14px] mt-[10px] ">
          <h1 className="text-[40px] text-white mb-[5px]">10+</h1>
          <p>CLIENTS</p>
          <p>WORLDWIDE</p>
